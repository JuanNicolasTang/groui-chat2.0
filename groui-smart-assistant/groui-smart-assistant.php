 ...
 * Description: Floating AI assistant integrated with OpenAI GPT‑5, WooCommerce and the site sitemap for contextual answers and product recommendations. Esta versión incorpora un rediseño visual del asistente (chat más ancho, barra de búsqueda de productos y mejoras de accesibilidad).
 * Version: 3.3.3
 * Author: TANG EL MEJOR
 * Text Domain: groui-smart-assistant
 * Domain Path: /languages
 *
 * Este es el archivo principal del plugin. Define constantes, carga las clases
 * requeridas y arranca la instancia singleton del asistente.  Además de
 * registrar el campo Domain Path para permitir traducciones, esta versión
 * incorpora un rediseño visual del asistente en el front‑end (chat más ancho,
 * barra de búsqueda de productos y mejoras de accesibilidad). Mantener este
 * archivo lo más ligero posible; toda la lógica se encuentra en las clases
 * del directorio `includes`.
 */
